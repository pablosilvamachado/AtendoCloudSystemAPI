...
using AtendoCloudSystem.Models.TokenAuth;
...
{
    public abstract class AtendoCloudSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AtendoCloudSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AtendoCloudSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AtendoCloudSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AtendoCloudSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AtendoCloudSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AtendoCloudSystemDbContext, Task<T>> func)
        {
            T result;
